...
@pytest.mark.asyncio
async def test_coalesce_node_prefers_first_non_null(debugger_server_port: int):
    project_path = fixture_path("nodes/coalesce_node/graphs/happy.rivet-project")
    ...
    assert outputs["out"] == {"type": "string", "value": "first"}

...
@pytest.mark.asyncio
async def test_object_node_interpolates_graph_inputs(debugger_server_port: int):
    project_path = fixture_path("nodes/object_node/graphs/happy.rivet-project")
    ...
    assert normalized == [
        ...
        {"message": "nodeStart", "node": {"id": "n2", "type": "object"}},
        {"message": "nodeFinish", "node": {"id": "n2", "type": "object"}},
    ...
    assert outputs["out"]["type"] == "object"
    assert outputs["out"]["value"] == {"greeting": "Ada", "echo": "Ada"}

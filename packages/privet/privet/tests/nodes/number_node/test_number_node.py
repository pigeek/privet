...
@pytest.mark.asyncio
async def test_number_node(debugger_server_port: int):
    project_path = fixture_path("nodes/number_node/graphs/happy.rivet-project")
    ...
    assert normalized == [
        ...
        {"message": "nodeStart", "node": {"id": "n1", "type": "number"}},
        {"message": "nodeFinish", "node": {"id": "n1", "type": "number"}},
    ...
    assert outputs["out"] == {"type": "number", "value": 42}

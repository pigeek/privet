...
@pytest.mark.asyncio
async def test_code_node_passthrough(debugger_server_port: int):
    project_path = fixture_path("nodes/code_node/graphs/happy.rivet-project")
    ...
    assert outputs["out"]["value"] == "first"

...
@pytest.mark.asyncio
async def test_replace_dataset_node(debugger_server_port: int):
    project_path = fixture_path("nodes/replace_dataset_node/graphs/happy.rivet-project")

...
@pytest.mark.asyncio
async def test_to_markdown_table_node(debugger_server_port: int):
    project_path = fixture_path("nodes/to_markdown_table_node/graphs/happy.rivet-project")
    ...
    assert normalized == [
        ...
        {"message": "nodeStart", "node": {"id": "n2", "type": "toMarkdownTable"}},
        {"message": "nodeFinish", "node": {"id": "n2", "type": "toMarkdownTable"}},

...
@pytest.mark.asyncio
async def test_play_audio_node(debugger_server_port: int):
    project_path = fixture_path("nodes/play_audio_node/graphs/happy.rivet-project")
    ...
    assert outputs["out"]["value"]["mediaType"] == "audio/wav"

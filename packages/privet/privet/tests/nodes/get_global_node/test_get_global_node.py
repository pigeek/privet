...
@pytest.mark.asyncio
async def test_get_global_node_after_set(debugger_server_port: int):
    project_path = fixture_path("nodes/get_global_node/graphs/happy.rivet-project")
    ...
    assert outputs["out"] == {"type": "string", "value": "shared"}

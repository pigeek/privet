...
@pytest.mark.asyncio
async def test_boolean_node(debugger_server_port: int):
    project_path = fixture_path("nodes/boolean_node/graphs/happy.rivet-project")
    ...
    assert normalized == [
        ...
        {"message": "nodeStart", "node": {"id": "n1", "type": "boolean"}},
        {"message": "nodeFinish", "node": {"id": "n1", "type": "boolean"}},

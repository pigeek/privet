...
@pytest.mark.asyncio
async def test_context_node_uses_context_values(debugger_server_port: int):
    project_path = fixture_path("nodes/context_node/graphs/happy.rivet-project")
    ...
    # No context provided; falls back to default value
    assert outputs["out"] == {"type": "string", "value": "guest"}

...
@pytest.mark.asyncio
async def test_to_yaml_node(debugger_server_port: int):
    project_path = fixture_path("nodes/to_yaml_node/graphs/happy.rivet-project")
    ...
    assert normalized == [
        ...
        {"message": "nodeStart", "node": {"id": "n2", "type": "toYaml"}},
        {"message": "nodeFinish", "node": {"id": "n2", "type": "toYaml"}},

...
@pytest.mark.asyncio
async def test_pop_node(debugger_server_port: int):
    project_path = fixture_path("nodes/pop_node/graphs/happy.rivet-project")
    ...
    assert normalized == [
        ...
        {"message": "nodeStart", "node": {"id": "n2", "type": "pop"}},
        {"message": "nodeFinish", "node": {"id": "n2", "type": "pop"}},
    ...
    assert outputs["item"] == {"type": "any", "value": 3}
    assert outputs["rest"] == {"type": "any[]", "value": [1, 2]}

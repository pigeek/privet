...
@pytest.mark.asyncio
async def test_graph_output_node_echo(debugger_server_port: int):
    project_path = fixture_path("nodes/graph_output_node/graphs/happy.rivet-project")
    ...
    assert normalized == [
        ...
        {"message": "nodeStart", "node": {"id": "n2", "type": "graphOutput"}},
        {"message": "nodeFinish", "node": {"id": "n2", "type": "graphOutput"}},

...
@pytest.mark.asyncio
async def test_url_reference_node(debugger_server_port: int):
    project_path = fixture_path("nodes/url_reference_node/graphs/happy.rivet-project")
    ...
    assert outputs["out"] == {
        "type": "object",
        "value": {"type": "url_reference", "url": "https://example.com"},
    }

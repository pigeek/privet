...
@pytest.mark.asyncio
async def test_set_and_get_global_node(debugger_server_port: int):
    project_path = fixture_path("nodes/set_global_node/graphs/happy.rivet-project")
    ...
    assert normalized == [
        ...
        {"message": "nodeStart", "node": {"id": "n2", "type": "setGlobal"}},
        {"message": "nodeFinish", "node": {"id": "n2", "type": "setGlobal"}},
        {"message": "nodeStart", "node": {"id": "n3", "type": "getGlobal"}},
        {"message": "nodeFinish", "node": {"id": "n3", "type": "getGlobal"}},

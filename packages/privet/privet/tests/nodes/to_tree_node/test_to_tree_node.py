...
@pytest.mark.asyncio
async def test_to_tree_node(debugger_server_port: int):
    project_path = fixture_path("nodes/to_tree_node/graphs/happy.rivet-project")
    ...
    assert normalized == [
        ...
        {"message": "nodeStart", "node": {"id": "n2", "type": "toTree"}},
        {"message": "nodeFinish", "node": {"id": "n2", "type": "toTree"}},

...
@pytest.mark.asyncio
async def test_slice_node(debugger_server_port: int):
    project_path = fixture_path("nodes/slice_node/graphs/happy.rivet-project")
    ...
    assert normalized == [
        ...
        {"message": "nodeStart", "node": {"id": "n2", "type": "slice"}},
        {"message": "nodeFinish", "node": {"id": "n2", "type": "slice"}},
    ...
    assert outputs["out"] == {"type": "any[]", "value": [2, 3, 4]}

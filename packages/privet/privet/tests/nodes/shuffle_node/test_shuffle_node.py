...
@pytest.mark.asyncio
async def test_shuffle_node(debugger_server_port: int):
    project_path = fixture_path("nodes/shuffle_node/graphs/happy.rivet-project")
    ...
    assert normalized == [
        ...
        {"message": "nodeStart", "node": {"id": "n2", "type": "shuffle"}},
        {"message": "nodeFinish", "node": {"id": "n2", "type": "shuffle"}},

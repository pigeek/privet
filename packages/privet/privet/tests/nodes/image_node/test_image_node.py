...
@pytest.mark.asyncio
async def test_image_node(debugger_server_port: int):
    project_path = fixture_path("nodes/image_node/graphs/happy.rivet-project")
    ...
    assert img["value"]["mediaType"] == "image/png"

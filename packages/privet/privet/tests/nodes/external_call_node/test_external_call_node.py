...
@pytest.mark.asyncio
async def test_external_call_node(debugger_server_port: int):
    project_path = fixture_path("nodes/external_call_node/graphs/happy.rivet-project")
    ...
    result = outputs["out"]
    assert result["value"]["function"] == "ping"

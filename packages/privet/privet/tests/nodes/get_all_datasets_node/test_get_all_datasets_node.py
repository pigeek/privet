...
@pytest.mark.asyncio
async def test_get_all_datasets_node(debugger_server_port: int):
    project_path = fixture_path("nodes/get_all_datasets_node/graphs/happy.rivet-project")
    ...
    datasets = outputs["out"]["value"]
    assert datasets and datasets[0]["id"] == "dsAll"

...
@pytest.mark.asyncio
async def test_delay_node(debugger_server_port: int):
    project_path = fixture_path("nodes/delay_node/graphs/happy.rivet-project")
    ...
    assert normalized == [
        ...
        {"message": "nodeStart", "node": {"id": "n2", "type": "delayNode"}},
        {"message": "nodeFinish", "node": {"id": "n2", "type": "delayNode"}},
    ...
    assert outputs["out"] == {"type": "string", "value": "done"}

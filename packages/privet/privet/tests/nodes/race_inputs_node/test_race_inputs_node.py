...
@pytest.mark.asyncio
async def test_race_inputs_node(debugger_server_port: int):
    project_path = fixture_path("nodes/race_inputs_node/graphs/happy.rivet-project")
    ...
    assert normalized == [
        ...
        {"message": "nodeStart", "node": {"id": "n3", "type": "raceInputs"}},
        {"message": "nodeFinish", "node": {"id": "n3", "type": "raceInputs"}},
    ...
    assert outputs["out"] == {"type": "string", "value": "winner"}

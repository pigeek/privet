...
@pytest.mark.asyncio
async def test_audio_node(debugger_server_port: int):
    project_path = fixture_path("nodes/audio_node/graphs/happy.rivet-project")
    ...
    assert audio["value"]["mediaType"] == "audio/wav"

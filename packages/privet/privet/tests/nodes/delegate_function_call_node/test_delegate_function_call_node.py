...
@pytest.mark.asyncio
async def test_delegate_function_call_node(debugger_server_port: int):
    project_path = fixture_path("nodes/delegate_function_call_node/graphs/happy.rivet-project")

...
@pytest.mark.asyncio
async def test_join_node(debugger_server_port: int):
    project_path = fixture_path("nodes/join_node/graphs/happy.rivet-project")
    ...
    assert normalized == [
        ...
        {"message": "nodeStart", "node": {"id": "n2", "type": "join"}},
        {"message": "nodeFinish", "node": {"id": "n2", "type": "join"}},
    ...
    assert outputs["out"] == {"type": "string", "value": "Hello, World"}

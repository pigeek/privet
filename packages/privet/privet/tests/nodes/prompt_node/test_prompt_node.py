...
@pytest.mark.asyncio
async def test_prompt_node_interpolation(debugger_server_port: int):
    project_path = fixture_path("nodes/prompt_node/graphs/happy.rivet-project")

...
@pytest.mark.asyncio
async def test_gpt_function_node(debugger_server_port: int):
    project_path = fixture_path("nodes/gpt_function_node/graphs/happy.rivet-project")
    ...
    fn = outputs["out"]
    assert fn["type"] == "gpt-function"
    assert fn["value"]["function"]["name"] == "doThing"
